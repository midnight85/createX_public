(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".special-offers-header__slider")) new core(".special-offers-header__slider", {
                ...
                navigation: {
                    prevEl: ".special-offers-header-button-prev",
                    nextEl: ".special-offers-header-button-next"
                },
                on: {}
            });
            ...
            if (document.querySelector(".new-arrivals__slider")) new core(".new-arrivals__slider", {
                ...
                lazy: true,
                pagination: {
                    el: ".new-arrivals__swiper-pagination",
                    clickable: true,
                    dynamicBullets: true,
            ...
            if (document.querySelector(".product-item__slider")) new core(".product-item__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                speed: 300,
                ...
                lazy: true,
                navigation: {
                    prevEl: ".product-item__swiper-button-prev",
                    nextEl: ".product-item__swiper-button-next"
                },
                on: {}
            });
            if (document.querySelector(".large-products-slider__swiper")) new core(".large-products-slider__swiper", {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                speed: 300,
                ...
                navigation: {
                    prevEl: ".large-products-slider__swiper-button-prev",
                    nextEl: ".large-products-slider__swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".insta__slider")) new core(".insta__slider", {
        ...
        function documentActions(e) {
            const targetElement = e.target;
            if (targetElement.closest(".menu-secondary__item_catalog")) {
                e.preventDefault();
            ...
            if (targetElement.closest("[data-parent-menu]")) {
                e.preventDefault();
                let megaMenu = document.querySelector(".mega-menu-catalog");
                const targetMenuBlock = document.querySelector(`[data-menu-id='${targetElement.dataset.parentMenu}']`);
                if (megaMenu) {
                    const activeMenuLink = document.querySelector(".mega-menu-link--active");
                    const activeMenuBlock = document.querySelector(".block-mega-menu--active");
                    megaMenu.classList.add("mega-menu-catalog--open");
                    if (activeMenuLink && activeMenuLink !== targetElement) {
                        activeMenuLink.classList.remove("mega-menu-link--active");
                        activeMenuBlock.classList.remove("block-mega-menu--active");
                    }
                    targetMenuBlock.classList.toggle("block-mega-menu--active");
                    targetElement.classList.toggle("mega-menu-link--active");
                    if (!document.querySelector(".block-mega-menu--active")) document.querySelector(".mega-menu-catalog--open").classList.remove("mega-menu-catalog--open");
                }
            }
            if (!(document.querySelector(".mega-menu-catalog__body") ? document.querySelector(".mega-menu-catalog__body").contains(targetElement) : null) && !targetElement.classList.contains("menu-catalog__link") || targetElement.classList.contains("block-mega-menu__link-back")) {
                e.stopPropagation();
                document.querySelector(".mega-menu-catalog--open") ? document.querySelector(".mega-menu-catalog--open").classList.remove("mega-menu-catalog--open") : null;
                document.querySelector(".mega-menu-link--active") ? document.querySelector(".mega-menu-link--active").classList.remove("mega-menu-link--active") : null;
                document.querySelector(".block-mega-menu--active") ? document.querySelector(".block-mega-menu--active").classList.remove("block-mega-menu--active") : null;
            }
            if (targetElement.closest("#agree-subscribe")) document.querySelector(".form-subscribe__btn").disabled = !targetElement.checked;
        }
        document.addEventListener("DOMContentLoaded", (function(e) {
            const bannerTimer = document.querySelector(".banner-item-timer");
            if (bannerTimer) {
                let countDownDate = new Date("Jun 25, 2022 18:00:00").getTime();
                let x = setInterval((function() {
                    ...
                    bannerTimer.querySelector("#days").innerHTML = days < 10 ? `0${days}` : days;
                    bannerTimer.querySelector("#hours").innerHTML = hours < 10 ? `0${hours}` : hours;
                    bannerTimer.querySelector("#minutes").innerHTML = minutes < 10 ? `0${minutes}` : minutes;
                    bannerTimer.querySelector("#seconds").innerHTML = seconds < 10 ? `0${seconds}` : seconds;
                    if (distance < 0) {
                        clearInterval(x);
                        document.getElementById("banner-item-timer_countdown").style.display = "none";
                        document.getElementById("banner-item-timer_content_end").style.display = "block";
                    }
                }), 1e3);
            }
        }));
